...
<head>
    ...
    <title>User Dashboard - PARTA</title>
    <!-- Leaflet CSS & JS -->
    ...
    <style>
        ...
        /* Overlay to ensure text readability if needed, though glass cards will handle it */
        .user-overlay {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="font-sans antialiased text-white overflow-x-hidden">
    ...
    <!-- Topbar -->
    <!-- Custom User Topbar (Static Dark Glass) -->
            ...
            @auth
                ...
                <div class="relative ml-2" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center gap-2 focus:outline-none">
                        <span class="text-sm font-manrope font-bold hidden md:block text-white">{{ auth()->user()->name }}</span>
    ...
    <!-- Main Content -->
    <main class="min-h-screen pt-[120px] px-4 md:px-10 pb-20"> <!-- Added padding for spacing -->
        @yield('content')
    </main>
